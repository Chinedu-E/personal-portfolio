...
import { SiTailwindcss, SiNodedotjs, SiPytorch, SiPandas, SiTensorflow, SiSelenium, SiScikitlearn, SiOpencv, SiNextdoor, SiNextdotjs, SiPostgresql, SiMongodb, SiStripe, SiTypescript } from "react-icons/si";
...
const about = {
  ...
  info: [
    ...
    {
      fieldName: "Email",
      fieldValue: "neduekeruche@gmail.com",
    },
    {
      fieldName: "Freelance",
...
const experience = {
  ...
  items: [
    {
      company: "SevenDot Analytics Inc.",
      position: "Full Stack Developer",
      duration: "2024 - Present",
    },
    {
      company: "Shutter Unit Photography",
...
const education = {
  ...
  items: [
    ...
    {
      institution: "Google",
      degree: "Professional Machine Learning Engineer",
      duration: "2023",
    },
    {
      institution: "Google",
...
const skills = {
  title: "My skills",
  description: "I have been exposed to various technologies and here's a few of them",
  skillList: [
    {
      icon: <FaHtml5 />,
      name: "html 5",
